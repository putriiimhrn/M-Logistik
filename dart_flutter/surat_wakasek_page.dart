...
class SuratWakasekPage extends StatefulWidget {
  const SuratWakasekPage({super.key});

  @override
  State<SuratWakasekPage> createState() => _SuratWakasekPageState();
}

class _SuratWakasekPageState extends State<SuratWakasekPage> {
  var surat = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: bottomAppBarSuratWakasek(context),
    );
  }
}
